        ...
        <div className="Timeline">
            ...
            <div className="Day">
                ...
                <div className="Activity">
                    ...
                    <button target="_blank" rel="noreferrer" className="Button Button--disabled">Invitation only</button>
                </div>
                <div className="Activity">
                    ...
                    <button className="Button Button--danger" disabled>Cancelled</button>
                </div>
            </div>
            <div className="Day">
            ...
            <div className="Day">
                <div data-num="17" className="Activity">
                    ...
                    <button href="/" target="_blank" rel="noreferrer" className="Button Button--disabled" disabled>Registration closed</button>
                </div>
                <div className="Activity">
